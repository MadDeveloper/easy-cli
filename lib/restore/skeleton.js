...
module.exports.command = 'skeleton'
module.exports.describe = 'Restore bundle skeleton into it initial state'
module.exports.handler = argv => {
    const bundleSkeletonPath = path.resolve( `${kernel.path.config}/bundles/skeleton` )
