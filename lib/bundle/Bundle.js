...
class Bundle {
    ...
    constructor( name, kernel ) {
        ...
        this.formattedNameDecapitalized = upperFirst( name )
        this.skeleton = null
    }
    ...
    async activate() {
        ...
        const content = await bundleActivationFile.read()
        ...
        content.replace( /module\.exports(\s*)=\s*\[/gi, addBundleInExports )

        return bundleActivationFile.setContent( content ).write()
    }
